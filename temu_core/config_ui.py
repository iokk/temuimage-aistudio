...
def build_settings_sections():
    return {
        "personal": {
            "gemini": {
                "title": "我的 Gemini 凭据",
                "desc": "使用自己的官方 Gemini / Vertex Key。",
                "badge": "个人",
            },
            "relay": {
                "title": "我的中转站凭据",
                "desc": "使用自己的中转站 URL / Key / 模型。",
                "badge": "个人",
            },
        },
        "system": {
            "gemini": {
                "title": "系统 Gemini 配置",
                "desc": "管理员统一维护的官方 Gemini / Vertex Key。",
                "badge": "系统",
            },
            "relay": {
                "title": "系统中转站配置",
                "desc": "管理员统一维护的中转站 URL / Key / 默认模型。",
                "badge": "系统",
            },
        },
    }
...
def build_recommended_provider_templates():
    return [
        ...
        },
        {
            ...
            "summary": "标题优化和图片翻译更稳定，适合使用官方 Gemini Key。",
        },
    ]
