...
def main() -> int:
    ...
    print(f"CASDOOR_CLIENT_ID={args.casdoor_client_id}")
    print(f"CASDOOR_CLIENT_SECRET={args.casdoor_client_secret}")
    print(f"CASDOOR_API_AUDIENCE={args.casdoor_api_audience}")
